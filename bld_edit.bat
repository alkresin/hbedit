...
bcc32 -ehbedit.exe -O2 -tW -I%HB_INSTALL%\include -L%HB_INSTALL%\lib\win\bcc hbdebug.lib hbrtl.lib gtwvt.lib gtgui.lib hbvm.lib hbpp.lib hbcommon.lib hbmacro.lib rddleto.lib hbrdd.lib rddntx.lib rddcdx.lib rddfpt.lib hbsix.lib hbct.lib hbcpage.lib hbpcre.lib hbcplr.lib ws2_32.lib hbedit.c fedit.c fmenu.c fcmd.c fgetsys.c hilight.c errorsys.c %SRC_PATH%\cfuncs.c
del *.obj
del *.c
del *.tds
