...
$HB_INS/bin/linux/gcc/harbour plug_py_init.prg -n -gh
$HB_INS/bin/linux/gcc/harbour plug_hbp_init.prg -n -gh
$HB_INS/bin/linux/gcc/harbour plug_hwprj_init.prg -n -gh
...
$HB_INS/bin/linux/gcc/harbour plug_games.prg -n -gh
...
$HB_INS/bin/linux/gcc/harbour plug_hbc_ext_all.prg -n -gh
...
$HB_INS/bin/linux/gcc/harbour plug_hugclient.prg -n -gh
cd ../../
