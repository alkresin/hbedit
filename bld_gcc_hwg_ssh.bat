...
%HB_INSTALL%\bin\harbour %SRC_PATH%\hbcommander.prg /n /q /w /dGTHWG  /d_USE_SSH2 -I%HB_INSTALL%\include %1 2>>harbour.out
...
gcc -I%HB_INSTALL%\include -D_USE_HB -DUNICODE -DGTHWG -c hbedit.c fedit.c fmenu.c fcmd.c fgetsys.c falert.c ffiles.c fkeymaps.c fdiff.c hilight.c fautoc.c errorsys.c hbcommander.c fview.c hbextcli.c hbcvf.c hbcssh2.c %SRC_PATH%\ssh2\hb_ssh2.c %SRC_PATH%\cfuncs.c %SRC_PATH%\trie\trie.c %SRC_PATH%\trie\hbtrie.c
