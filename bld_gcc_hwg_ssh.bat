...
gcc -I%HB_INSTALL%\include -D_USE_HB -DUNICODE -DGTHWG -c hbedit.c fedit.c fmenu.c fcmd.c fgetsys.c falert.c ffiles.c fkeymaps.c fdiff.c hilight.c fautoc.c errorsys.c hbcommander.c fview.c hbcvf.c hbcssh2.c %SRC_PATH%\ssh2\hb_ssh2.c %SRC_PATH%\cfuncs.c %SRC_PATH%\trie\trie.c %SRC_PATH%\trie\hbtrie.c
