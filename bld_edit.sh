...
gcc -I. -I$HB_INS/include -Wall -c hbedit.c fedit.c fcmd.c fmenu.c fgetsys.c ffiles.c fkeymaps.c hilight.c errorsys.c $SRC_DIR/cfuncs.c
gcc -Wall -ohbedit hbedit.o fedit.o fcmd.o fmenu.o fgetsys.o ffiles.o fkeymaps.o hilight.o errorsys.o cfuncs.o -L $HB_INS/lib/linux/gcc  \
