...
gcc -I. -I$HB_INS/include -Wall -c hbedit.c fedit.c fcmd.c fmenu.c fgetsys.c falert.c ffiles.c fkeymaps.c fdiff.c hilight.c fautoc.c errorsys.c $SRC_DIR/cfuncs.c
gcc -Wall -ohbedit hbedit.o fedit.o fcmd.o fmenu.o fgetsys.o falert.o ffiles.o fdiff.o fkeymaps.o hilight.o fautoc.o errorsys.o cfuncs.o -L $HB_INS/lib/linux/gcc  \
