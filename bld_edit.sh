...
gcc -I. -I$HB_INS/include -Wall -c hbedit.c fedit.c fcmd.c fmenu.c fgetsys.c falert.c ffiles.c fkeymaps.c fdiff.c hilight.c fautoc.c errorsys.c $SRC_DIR/cfuncs.c $SRC_DIR/trie.c $SRC_DIR/hbtrie.c
