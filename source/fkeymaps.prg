...
STATIC hKeysMap1 := { 0x41020051=>"Ctrl-Q", 0x41020057=>"Ctrl-W", 0x41020045=>"Ctrl-E", ;
   ...
   0x4102004D=>"Ctrl-M", ;
   0x41040071=>"Alt-Q", 0x41040077=>"Alt-W", 0x41040065=>"Alt-E", 0x41040072=>"Alt-R", ;
   0x41040074=>"Alt-T", 0x41040069=>"Alt-Y", 0x41040075=>"Alt-U", 0x41040069=>"Alt-I", ;
   0x4104006F=>"Alt-O", 0x41040070=>"Alt-P", 0x4104007B=>"Alt-[", 0x4104007D=>"Alt-]", ;
   0x41040061=>"Alt-A", 0x41040073=>"Alt-S", 0x41040064=>"Alt-D", 0x41040066=>"Alt-F", ;
   0x41040067=>"Alt-G", 0x41040068=>"Alt-H", 0x4104006A=>"Alt-J", 0x4104006B=>"Alt-K", ;
   0x4104006C=>"Alt-L", 0x4104003B=>"Alt-;", 0x41040027=>"Alt-'", 0x4104007A=>"Alt-Z", ;
   0x41040078=>"Alt-X", 0x41040063=>"Alt-C", 0x41040076=>"Alt-V", 0x41040062=>"Alt-B", ;
   0x4104006E=>"Alt-N", 0x4104006D=>"Alt-M", 0x4104002C=>"Alt-,", 0x4104002E=>"Alt-.", ;
   ...
   0x4100000D=>"Up", 0x4100000E=>"Down", 0x4100000F=>"Left", 0x41000010=>"Right" }
...
STATIC hKeysMap2 := { "Ctrl-Q"=>0x41020051, "Ctrl-W"=>0x41020057, "Ctrl-E"=>0x41020045, ;
   ...
   "Ctrl-M"=>0x4102004D, ;
   "Alt-Q"=>0x41040071, "Alt-W"=>0x41040077, "Alt-E"=>0x41040065, "Alt-R"=>0x41040072, ;
   "Alt-T"=>0x41040074, "Alt-Y"=>0x41040069, "Alt-U"=>0x41040075, "Alt-I"=>0x41040069, ;
   "Alt-O"=>0x4104006F, "Alt-P"=>0x41040070, "Alt-["=>0x4104007B, "Alt-]"=>0x4104007D, ;
   "Alt-A"=>0x41040061, "Alt-S"=>0x41040073, "Alt-D"=>0x41040064, "Alt-F"=>0x41040066, ;
   "Alt-G"=>0x41040067, "Alt-H"=>0x41040068, "Alt-J"=>0x4104006A, "Alt-K"=>0x4104006B, ;
   "Alt-L"=>0x4104006C, "Alt-;"=>0x4104003B, "Alt-'"=>0x41040027, "Alt-Z"=>0x4104007A, ;
   "Alt-X"=>0x41040078, "Alt-C"=>0x41040063, "Alt-V"=>0x41040076, "Alt-B"=>0x41040062, ;
   "Alt-N"=>0x4104006E, "Alt-M"=>0x4104006D, "Alt-,"=>0x4104002C, "Alt-."=>0x4104002E, ;
   ...
   "Up"=>0x4100000D, "Down"=>0x4100000E, "Left"=>0x4100000F, "Right"=>0x41000010 }
#else
STATIC hKeysMap1 := { 0x41020051=>"Ctrl-Q", 0x41020057=>"Ctrl-W", 0x41020045=>"Ctrl-E", ;
   0x41020052=>"Ctrl-R", 0x41020054=>"Ctrl-T", 0x41020059=>"Ctrl-Y", 0x41020055=>"Ctrl-U", ;
   0x41020049=>"Ctrl-I", 0x4102004F=>"Ctrl-O", 0x41020050=>"Ctrl-P", 0x4102005B=>"Ctrl-[", ;
