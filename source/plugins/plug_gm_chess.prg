...
STATIC FUNCTION chess_Help()
   ...
   @ y1t+2, x1t + 4 SAY Iif( lRussian, "F9 - Главне меню", "F9 - Main menu" )
   @ y1t+3, x1t + 4 SAY Iif( lRussian, "F2 - Сохранить файл, F4 - Загрузить файл", "F2 - Save file, F4 - Load file" )
   @ y1t+4, x1t + 4 SAY Iif( lRussian, "F3 - Новая партия, F5 - Созлать диаграмму", "F3 - New game,  F5 - Set a diagramm" )
