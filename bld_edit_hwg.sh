...
$HB_INS/bin/linux/gcc/harbour $SRC_DIR/fedit.prg  -n -q0 -es2 -gc0 -d__GTHWG__ -d_FULL -I$HB_INS/include
...
$HB_INS/bin/linux/gcc/harbour $SRC_DIR/hbcommander.prg  -n -q0 -es2 -gc0 -d__GTHWG__ -I$HB_INS/include
